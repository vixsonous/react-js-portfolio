  ...
  return (
    <React.Fragment>
      <motion.header
        ...
        className="fixed flex top-0 left-0 z-30 justify-between transition-all p-[1em] items-center w-full"
      >
        <div>
          <MovingText
            text="chiong."
        ...
        <div className="">
          <section
            ...
            className="flex gap-[1em] text-xs font-light items-center"
          >
            <Link
            ...
            >
              <span
                style={{ color: theme.primary }}
                className={`px-[10px] py-[5px] transition-all`}
              >
                Myself
              </span>
              <div
                ...
                className={`absolute transition-all ${
                  state.abt ? "w-full" : "w-0"
                } group-hover:w-full h-[2px] bottom-[-8px]`}
              ></div>
            </Link>
            <Link
              className="relative group"
      ...
      {sm() ? (
        <motion.div
          ...
          className="privacy-screen fixed top-0 left-0 right-0 bottom-0 z-50"
        />
      ) : (
        <motion.div
          initial={{ scaleX: 1 }}
