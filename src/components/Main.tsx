        ...
        <SmoothScroll>
            <main className=" min-h-[100vh] flex flex-wrap flex-[1_0_100%] relative p-[20px] lg:pb-[100px] xl:pb-[0px] lg:p-[0px] max-w-[1160px] ">
                <section className="pt-[100px] min-h-[100vh] flex-[1_0_50%]">
                    ...
                    <motion.h1 className={`w-[100%] lg:w-[70%] text-[${text.body}] w-[100%] flex flex-wrap`}>{`I am `.split("").map((char, idx) => <motion.span className='relative' transition={{ delay:  + .4 + idx * 0.003 }} key={idx} initial={{opacity: 0, y: -10}} animate={{opacity: 1, y: 0}}>{char === " " ? <span>&nbsp;</span> : char}</motion.span>)}</motion.h1>
                    <motion.h1 
